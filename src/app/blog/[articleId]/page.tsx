...
const page = async ({ params }) => {
  ...
  return (
    <section className="container mx-auto py-10 px-3 font-jf flex items-start justify-between flex-col xl:flex-row">
      <div className="max-w-[800px] 2xl:max-w-[1000px] prose prose-green prose-headings:text-lemon-green prose-img:max-h-96 prose-img:w-full prose-img:rounded-md prose-img:object-cover prose-blockquote:text-neutral-300 prose-img:cover prose-p:text-white">
